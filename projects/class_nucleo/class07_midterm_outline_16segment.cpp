...
//variable to control state of 16-segment display
...
void display_control(void)
{
    ...
    if(display_state == 0)
        ...
        display_character_9();
    else if(display_state == 10)
        display_character_A();
    else if(display_state == 11)
        display_character_B();
    else if(display_state == 12)
        display_character_C();
    else if(display_state == 13)
        display_character_D();
    else if(display_state == 14)
        display_character_E();
    else if(display_state == 15)
        display_character_F();
